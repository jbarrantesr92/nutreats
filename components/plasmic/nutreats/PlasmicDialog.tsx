...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: RQ7kTsr2DY2m/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_v6YPvttC7Alb"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__ovLet)}
              >
                <div
                  className={classNames(
                    projectcss.all,
