...
import sty from "./PlasmicNutreatsBlueButton.module.css"; // plasmic-import: uIhZslhj_xpS/css
...
export type PlasmicNutreatsBlueButton__VariantMembers = {
...
export type PlasmicNutreatsBlueButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicNutreatsBlueButton__VariantsArgs;
export const PlasmicNutreatsBlueButton__VariantProps =
...
export type PlasmicNutreatsBlueButton__ArgsType = {
...
type ArgPropType = keyof PlasmicNutreatsBlueButton__ArgsType;
export const PlasmicNutreatsBlueButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicNutreatsBlueButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultNutreatsBlueButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicNutreatsBlueButton__RenderFunc(props: {
  variants: PlasmicNutreatsBlueButton__VariantsArgs;
  args: PlasmicNutreatsBlueButton__ArgsType;
  overrides: PlasmicNutreatsBlueButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__nvxU)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__jtKhW)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicNutreatsBlueButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicNutreatsBlueButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicNutreatsBlueButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicNutreatsBlueButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicNutreatsBlueButton__ArgProps,
          internalVariantPropNames: PlasmicNutreatsBlueButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicNutreatsBlueButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicNutreatsBlueButton";
  } else {
    func.displayName = `PlasmicNutreatsBlueButton.${nodeName}`;
  }
  return func;
}

export const PlasmicNutreatsBlueButton = Object.assign(
  // Top-level PlasmicNutreatsBlueButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicNutreatsBlueButton
    internalVariantProps: PlasmicNutreatsBlueButton__VariantProps,
    internalArgProps: PlasmicNutreatsBlueButton__ArgProps,

    useBehavior
  }
);

export default PlasmicNutreatsBlueButton;
/* prettier-ignore-end */
