...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: H-ky2REMUn-l/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: TqPngYlk0I_L/icon
...
export type PlasmicTextInput__VariantsArgs = {
  ...
  color?: SingleChoiceArg<"dark" | "noBorder">;
};
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_noBorder]: hasVariant($state, "color", "noBorder"),
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__tXcZ)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputcolor_noBorder]: hasVariant($state, "color", "noBorder"),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___0Gv9B)}
              role={"img"}
            />
          ),
